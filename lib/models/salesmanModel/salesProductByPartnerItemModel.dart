class SalesProductByPartnerItemModel {
  String? status;
  List<Data>? data;
  String? message;

  SalesProductByPartnerItemModel({this.status, this.data, this.message});

  SalesProductByPartnerItemModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
