class SalesWishListModel {
  String? status;
  List<Data>? data;
  String? message;

  SalesWishListModel({this.status, this.data, this.message});

  SalesWishListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['store_id'] != null) {
      storeId = <StoreId>[];
      json['store_id'].forEach((v) {
        storeId!.add(new StoreId.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.storeId != null) {
      data['store_id'] = this.storeId!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
