...
import 'package:pet/screens/wholesaler/paymentdone.dart';
import 'package:pet/utils/colors.dart';
import 'package:pet/utils/fontstyle.dart';
import 'package:upi_india/upi_india.dart';

class PartnerUpiScreen extends StatefulWidget {
    PartnerUpiScreen({super.key,this.amount});
    double? amount;
  @override
  _PartnerUpiScreenState createState() => _PartnerUpiScreenState();
}

class _PartnerUpiScreenState extends State<PartnerUpiScreen> {
...
Get.to(PartnerPaymentDoneScreen());
