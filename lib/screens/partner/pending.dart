...
class Pendingpartner extends StatefulWidget {
  const Pendingpartner({super.key});

  @override
  State<Pendingpartner> createState() => _PendingpartnerState();
}
...
// Get.to(Homesales());
                                                                                 ...
                                                                                 child: Container(
                                                                                                                          ...
                                                                                                                          child:Center(child: Text("Add Product",style: CustomTextStyle.popinstextsmall124,))
                                                                                                                          ),
                                                                               ),
                                           SizedBox(width:20),
                                               InkWell(
...
// Get.to(OrderHistorysales());
                                                 ...
                                                 child: Container(
                                                                                          ...
                                                                                          borderRadius: BorderRadius.circular(26.405324935913086),
                                                                                          color:MyColors.red),
                                                                                          child:Center(child: Text("Reject",style: CustomTextStyle.popinstextsmall124,))
                                                                                          ),
                                               )
