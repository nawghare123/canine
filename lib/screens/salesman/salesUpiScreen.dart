...
import 'package:pet/screens/salesman/paymentdone.dart';
...
class SalesUpiScreen extends StatefulWidget {
    SalesUpiScreen({super.key,this.amount});
    double? amount;
  @override
  _SalesUpiScreenState createState() => _SalesUpiScreenState();
}

class _SalesUpiScreenState extends State<SalesUpiScreen> {
...
Get.to(PaymentDoneScreensales());
   mycartController. salesplaceorder();
