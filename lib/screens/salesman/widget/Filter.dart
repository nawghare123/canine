...
class FilterScreenWholeseller extends StatefulWidget {
  @override
  _FilterScreenWholesellerState createState() => _FilterScreenWholesellerState();
}

class _FilterScreenWholesellerState extends State<FilterScreenWholeseller> {
                          ...
                          body: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              final filteroption =
                                  ...
                                  print("Brandvvvvvvm  ${filteroption}");
