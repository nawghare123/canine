...
import 'package:pet/screens/salesman/widget/orderReturnReasonsDialog.dart';
// import 'package:pet/screens/wholesaler/widget/orderReturnReasonsDialog.dart';

class OrderReturnDialogsales extends StatelessWidget {
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          Get.back();
                          // Get.back();
                          Get.dialog(OrderReturnReasonsDialogsales());
                        },
                        child: Text('Confirm'),
                      ),
                    ],
