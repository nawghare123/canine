...
import 'package:pet/screens/salesman/widget/orderRturnOtherDialog.dart';
...
class OrderReturnReasonsDialogsales extends StatelessWidget {
  // List of cancellation reasons
  final SalesLocationController controller = Get.find<SalesLocationController>();
...
//                           Get.back();
                            if (controller.selectedValue != null) {
                              if (controller.selectedValue == 'Other') {
                                ...
                                Get.dialog(OrderReturnOtherDialogsales());
                                return;
                              }
