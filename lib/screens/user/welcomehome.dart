                ...
                InkWell(onTap: (){
                 // Navigator.push(context, MaterialPageRoute(builder: (context)=>ProductDetails()));
                  ...
                  child: Container(
                          ...
                          CircleAvatar(radius: 45,child: Image.asset("assets/image/firstimg.png"),),
              ...
              InkWell(onTap: (){
                 // Navigator.push(context, MaterialPageRoute(builder: (context)=>ProductDetails()));
                  ...
                  children: [
                               Center(
                                 child: Text(
                                                       ' Total pending order',textAlign: TextAlign.center,
                                                       style:  CustomTextStyle.  popinsmedium
               ...
               InkWell(onTap: (){
                 // Navigator.push(context, MaterialPageRoute(builder: (context)=>ProductDetails()));
                  ...
                  child: Container(
                          ...
                          SizedBox(height: MediaQuery.of(context).size.height*0.03,),
                          CircleAvatar(radius: 45,backgroundColor: Colors.green,
                  ...
                  children: [
                               Text(
                        'Total up coming order', textAlign: TextAlign.center,
                        style:  CustomTextStyle.  popinsmedium
              ...
              InkWell(onTap: (){
                 // Navigator.push(context, MaterialPageRoute(builder: (context)=>ProductDetails()));
                  ...
                  children: [
                               Center(
                                 child: Text(
                                                       'Total earning',textAlign: TextAlign.center,
                                                       style:  CustomTextStyle.  popinsmedium
